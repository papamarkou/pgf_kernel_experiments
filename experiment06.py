...
titles = ['Fourier series', 'Training data', 'Test data']
...
class ExactGPModel(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood):
        ...
        # self.covar_module = GFKernel(num_p=[20, 20, 20])
        self.covar_module = gpytorch.kernels.ScaleKernel(GFKernel(num_p=[20, 20, 20]))
...
titles = ['Fourier series', 'Training data', 'Test data', 'Predictions']
