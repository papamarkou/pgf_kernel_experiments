...
from pgf_kernel_experiments.experiments.cox_process.kernel_comparison.setting01.set_env import num_runs, output_paths
...
for run_count in range(num_runs):
    ...
    for kernel_name in kernel_names:
        all_predictions.append(np.loadtxt(output_paths[run_count].joinpath(kernel_name+'_dkl_predictions.csv')))
