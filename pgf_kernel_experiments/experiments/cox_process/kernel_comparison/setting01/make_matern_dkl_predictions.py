...
for run_count in range(num_runs):
    ...
    runner.model.load_state_dict(torch.load(output_paths[run_count].joinpath('matern_dkl_state.pth')))
    ...
    np.savetxt(
        output_paths[run_count].joinpath('matern_dkl_predictions.csv'),
    ...
    np.savetxt(
        output_paths[run_count].joinpath('matern_dkl_error_metrics.csv'),
...
np.savetxt(
    output_basepath.joinpath('matern_dkl_error_metric_means.csv'),
...
np.savetxt(
    output_basepath.joinpath('matern_dkl_error_metric_stds.csv'),
