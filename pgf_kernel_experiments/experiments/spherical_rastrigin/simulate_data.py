...
from pgf_kernel_experiments.experiments.spherical_rastrigin.set_paths import data_path
...
def gen_spherical_rastrigin_data(phi, theta, a, b):
    ...
    for i in range(n_rows):
        for j in range(n_cols):
            freqs[i, j] = spherical_rastrigin_function(phi[i], theta[j], a, b)
...
x, y, z, freqs = gen_spherical_rastrigin_data(phi, theta, a, b)
