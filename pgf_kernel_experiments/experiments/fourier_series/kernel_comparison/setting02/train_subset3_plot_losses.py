...
from pgf_kernel_experiments.experiments.fourier_series.kernel_comparison.setting02.set_env import output_path

# %% Load predictions

losses = np.loadtxt(
    output_path.joinpath('train_subset3_losses.csv'),
    delimiter=',',
    skiprows=1
)
...
plt.savefig(
    output_path.joinpath('train_subset3_losses.png'),
    dpi=600,
