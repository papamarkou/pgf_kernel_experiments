...
from pgf_kernel_experiments.experiments.von_mises.kernel_comparison.setting02.set_env import output_path
...
plt.yticks(np.arange(1, 10+2, 2), fontsize=axis_fontsize)
